...
$factory->defineAs(\Modulatte\Pages\Models\Page::class, 'terms', function() use($simpleHtml) {
    return [
...
$factory->defineAs(\Modulatte\Pages\Models\Page::class, 'privacy', function() use($simpleHtml) {
    return [
        'title' => 'Privacy',
        'slug' => 'privacy',
        'data' => [
...
$factory->defineAs(\Modulatte\Pages\Models\Page::class, 'about-us', function() use($simpleHtml) {
    return [
        'title' => 'About Us',
        'slug' => 'about-us',
        'data' => [
