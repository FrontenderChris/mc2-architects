...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here you may specify a global value to be used for when paginating items.
    | It is a good idea to set a default amount so it can be easily changed
    | in the future on a global level. Access via config('app.pagination')
    |
    */
...
//    'locale' => 'en',
    ...
    */
    ...
    'providers' => [
        ...
        //Illuminate\View\ViewServiceProvider::class, // Using custom one below
...
//        Modulatte\Categories\CategoriesServiceProvider::class,
