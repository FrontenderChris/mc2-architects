<div class="form-group">
    ...
    <div class="col-sm-10">
        {{ Form::text('user[name]', $user->name, ['class' => 'form-control', 'maxlength' => 100]) }}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {{ Form::text('user[email]', $user->email, ['class' => 'form-control', 'maxlength' => 100]) }}
    </div>
</div>
...
@if (hasLoginPackage())
    <div class="form-group">
        ...
        <div class="col-sm-10">
            {{ Form::select('role_id', role()->getList(), $user->role_id, ['class' => 'form-control', 'data-placeholder' => 'User Role']) }}
        </div>
    </div>
@endif
