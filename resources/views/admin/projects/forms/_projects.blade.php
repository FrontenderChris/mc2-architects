...
@include('cropper::_modal', ['uniqueKey' => '0', 'image' => (!empty($model) ? $model->image('banner') : null) ])
@include('cropper::_modal', ['uniqueKey' => '1', 'image' => (!empty($model) ? $model->image('hero1') : null) ])
@include('cropper::_modal', ['uniqueKey' => '2', 'image' => (!empty($model) ? $model->image('hero2') : null) ])
@include('cropper::_modal', ['uniqueKey' => '3', 'image' => (!empty($model) ? $model->image('hero3') : null) ])
@include('cropper::_modal', ['uniqueKey' => '4', 'image' => (!empty($model) ? $model->image('hero4') : null) ])
@include('cropper::_modal', ['uniqueKey' => '5', 'image' => (!empty($model) ? $model->image('hero5') : null) ])
@include('cropper::_modal', ['uniqueKey' => '6', 'image' => (!empty($model) ? $model->image('hero6') : null) ])
