...
--><div class="col-xs-4 align-right vcenter">
    <div class="btn-group" role="group">
        <button type="button" class="btn btn-default" title="Edit" data-url="{{ route('admin.projects.edit', $model->id) }}">
        ...
        @if (config('products.canDeleteAll') || $model->is_dynamic)
            ...
            <button type="button" class="btn btn-default do-delete-page" data-target="{{ route('admin.projects.destroy', $model->id) }}" title="Delete">
