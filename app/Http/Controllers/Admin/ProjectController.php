...
class ProjectController extends Controller
{
    ...
    {
        $pages = Page::where('slug', 'projects')->get();

        return view('projects.index', compact('pages'));
    }
    ...
    public function create()
    {
        ...
        return view('projects.create', compact('form'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('projects.edit', compact('model', 'form'));
    }
    ...
    public function store(SavePageRequest $request)
    {
        ...
        if ($request->has('redirectBack'))
            return redirect()->route('admin.projects.edit', $page->id)->with('success-msg', 'Project successfully created.');
